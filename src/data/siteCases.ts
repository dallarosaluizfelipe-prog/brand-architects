...
const fallbackCases: SiteCase[] = [
  ...
  },
  {
    ...
    gallery_urls: [
      ...
      "/lovable-uploads/clave-11.gif",
      "/lovable-uploads/clave-12.png",
      "/lovable-uploads/clave-13.png",
      "/lovable-uploads/clave-14.png",
      "/lovable-uploads/clave-15.png",
      "/lovable-uploads/clave-16.png",
      "/lovable-uploads/clave-17.png",
      "/lovable-uploads/clave-18.png",
    ],
    author: "Studio Dalla",
  ...
  },
  {
    ...
    category: "Branding  -   Identidade Visual   -   Embalagem",
    description:
      "A Nuts O'Clock é uma marca de snacks saudáveis que propõe uma pausa leve, divertida e saborosa no dia a dia. O projeto nasceu da busca por uma identidade visual com presença e apelo afetivo. O desafio foi equilibrar uma estética doce com a leveza de um produto saudável.\n\nCom base nos pilares sabor, energia e afeto, a identidade combina tipografia vibrante, paleta cremosa e elementos feitos à mão, criando uma marca que desperta o paladar antes mesmo da primeira mordida.",
    cover_url: "/lovable-uploads/nuts-oclock-cover.gif",
    gallery_urls: [
      "/lovable-uploads/nuts-1.png",
      "/lovable-uploads/nuts-2.png",
      "/lovable-uploads/nuts-3.png",
      "/lovable-uploads/nuts-4.png",
      "/lovable-uploads/nuts-5.png",
      "/lovable-uploads/nuts-6.png",
      "/lovable-uploads/nuts-7.png",
      "/lovable-uploads/nuts-8.png",
      "/lovable-uploads/nuts-9.png",
      "/lovable-uploads/nuts-10.gif",
      "/lovable-uploads/nuts-11.png",
      "/lovable-uploads/nuts-12.png",
      "/lovable-uploads/nuts-13.png",
      "/lovable-uploads/nuts-14.png",
    ],
    author: "Studio Dalla",
  ...
  },
  {
    ...
    category: "Branding  -   Identidade Visual   -   Embalagem",
    description:
      "Identidade visual para a Lummina, marca de velas artesanais que propõe rituais de pausa e conexão. O projeto traduz seu universo sensível e espiritual com sofisticação, evitando clichês. A identidade foi construída a partir dos pilares luz, essência e intuição, com uma estética acolhedora, tipografia fluida e paleta colorida, resultando em uma marca que acolhe, inspira e guia.\n\nA Lummina acredita que uma pequena chama pode iluminar grandes causas.",
    cover_url: "/lovable-uploads/lummina-cover.png",
    gallery_urls: [
      "/lovable-uploads/lummina-1.png",
      "/lovable-uploads/lummina-2.png",
      "/lovable-uploads/lummina-3.png",
      "/lovable-uploads/lummina-4.png",
      "/lovable-uploads/lummina-5.gif",
      "/lovable-uploads/lummina-6.png",
      "/lovable-uploads/lummina-7.png",
