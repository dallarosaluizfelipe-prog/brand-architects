      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 md:gap-20">
        ...
        <div className="bg-white p-6 md:p-12 rounded-3xl text-black shadow-2xl">
          ...
          <form className="space-y-5 md:space-y-6 font-sans" onSubmit={handleSubmit}>
            <input aria-label="Nome" name="name" value={form.name} onChange={handleChange} className="border-b border-neutral-200 border-x-0 border-t-0 focus:ring-0 focus:border-black w-full px-0 py-4 placeholder:text-neutral-400 font-light" type="text" required placeholder="Nome *" />
            <input aria-label="Telefone" name="phone" value={form.phone} onChange={handleChange} className="border-b border-neutral-200 border-x-0 border-t-0 focus:ring-0 focus:border-black w-full px-0 py-4 placeholder:text-neutral-400 font-light" type="tel" required placeholder="Telefone *" />
            <input aria-label="Email" name="email" value={form.email} onChange={handleChange} className="border-b border-neutral-200 border-x-0 border-t-0 focus:ring-0 focus:border-black w-full px-0 py-4 placeholder:text-neutral-400 font-light" placeholder="Email *" type="email" required />
            <input aria-label="Nome da empresa" name="company" value={form.company} onChange={handleChange} className="border-b border-neutral-200 border-x-0 border-t-0 focus:ring-0 focus:border-black w-full px-0 py-4 placeholder:text-neutral-400 font-light" type="text" placeholder="Nome da empresa" />
            <select aria-label="Serviço de interesse" name="service" value={form.service} onChange={handleChange} className="border-b border-neutral-200 border-x-0 border-t-0 focus:ring-0 focus:border-black w-full px-0 py-4 text-neutral-400 font-light appearance-none bg-transparent">
