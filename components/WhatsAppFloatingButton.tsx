...
const WhatsAppFloatingButton: React.FC = () => {
  return (
    <a
      ...
      className="fixed right-5 bottom-5 md:right-8 md:bottom-8 z-40 h-[52px] w-[52px] md:h-14 md:w-14 rounded-full bg-[#25D366] text-white shadow-[0_4px_14px_rgba(37,211,102,0.4)] transition-all duration-200 hover:scale-105 hover:shadow-[0_6px_20px_rgba(37,211,102,0.5)] focus:outline-none flex items-center justify-center"
    >
