...
const Methodology: React.FC = () => {
  ...
  return (
    <div className="animate-in fade-in duration-700">
      <header className="relative h-[95vh] flex flex-col justify-center items-center overflow-hidden bg-black text-white rounded-b-[4rem] md:rounded-b-[6rem] pt-24 md:pt-32">
