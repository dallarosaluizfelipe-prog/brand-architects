...
const Methodology: React.FC = () => {
  ...
  const s = useSiteTextStyles(
    [
      'method_header_badge','method_header_title','method_header_subtitle',
      'method_phase1_label','method_phase1_title','method_phase1_desc',
      'method_phase2_label','method_phase2_title','method_phase2_desc',
      'method_phase3_label','method_phase3_title','method_phase3_desc',
      'method_phase4_label','method_phase4_title','method_phase4_desc',
      'method_phase5_label','method_phase5_title','method_phase5_desc',
    ],
    locale,
  );

  const phases = [
    { id: 'I',   label: t.method_phase1_label, title: t.method_phase1_title, desc: t.method_phase1_desc, labelStyle: s.method_phase1_label, titleStyle: s.method_phase1_title, descStyle: s.method_phase1_desc, image: t.method_phase1_image },
    { id: 'II',  label: t.method_phase2_label, title: t.method_phase2_title, desc: t.method_phase2_desc, labelStyle: s.method_phase2_label, titleStyle: s.method_phase2_title, descStyle: s.method_phase2_desc, image: t.method_phase2_image },
    { id: 'III', label: t.method_phase3_label, title: t.method_phase3_title, desc: t.method_phase3_desc, labelStyle: s.method_phase3_label, titleStyle: s.method_phase3_title, descStyle: s.method_phase3_desc, image: t.method_phase3_image },
    { id: 'IV',  label: t.method_phase4_label, title: t.method_phase4_title, desc: t.method_phase4_desc, labelStyle: s.method_phase4_label, titleStyle: s.method_phase4_title, descStyle: s.method_phase4_desc, image: t.method_phase4_image },
    { id: 'V',   label: t.method_phase5_label, title: t.method_phase5_title, desc: t.method_phase5_desc, labelStyle: s.method_phase5_label, titleStyle: s.method_phase5_title, descStyle: s.method_phase5_desc, image: t.method_phase5_image },
  ];
      ...
      <div className="animate-in fade-in duration-700">
        <header className="relative min-h-[50svh] md:h-[95vh] flex flex-col justify-start items-center overflow-hidden bg-black text-white rounded-b-[2.5rem] md:rounded-b-[6rem] pt-24 md:pt-[180px] pb-14 md:pb-0">
          ...
          <div className="relative z-10 max-w-5xl w-full text-center px-6">
            <span className="tracking-[0.45em] text-white/40 mb-7 block font-sans text-[11px] md:text-sm font-normal" style={s.method_header_badge}>{t.method_header_badge}</span>
            ...
            <div className="max-w-2xl mx-auto text-base md:text-lg text-white/60 font-sans leading-relaxed" style={s.method_header_subtitle} dangerouslySetInnerHTML={{ __html: t.method_header_subtitle }} />
          </div>
        </header>
                ...
                <div className="grid md:grid-cols-[40%_1fr] gap-8 md:gap-16 items-center">
                  ...
                  <div className="order-2 md:order-2">
                    <div className="flex flex-col gap-2 mb-6 md:mb-8">
                      ...
                      <span className="text-[11px] tracking-[0.35em] text-neutral-400 font-bold font-sans" style={phase.labelStyle}>{phase.label}</span>
                    </div>
                    ...
                    <div className="text-lg md:text-xl text-neutral-500 font-sans leading-relaxed" style={phase.descStyle} dangerouslySetInnerHTML={{ __html: phase.desc }} />
                  </div>
                </div>
