    ...
    <>
      ...
      <div className="animate-in fade-in duration-700">
        <header className="pt-36 md:pt-48 pb-12 md:pb-20 px-6 max-w-7xl mx-auto">
          <h1 className="text-5xl sm:text-6xl md:text-[12rem] leading-[0.82] tracking-tighter mb-8 md:mb-24 font-display">Let's talk.</h1>
        </header>
          ...
          <div className="grid md:grid-cols-12 gap-12 md:gap-32">
            <div className="md:col-span-4 space-y-12 md:space-y-20 font-sans">
              <section>
                ...
                <p className="font-light leading-relaxed uppercase tracking-[0.22em] text-neutral-800 text-sm md:text-lg">CURITIBA / BR / PR
                  <br />TEL +55 42 9 9915 3014
                  <br />Central Office
              ...
              <section>
                ...
                <p className="font-light tracking-[0.15em] text-neutral-800 text-xs md:text-lg break-words">
                  <a className="hover:opacity-60 transition-opacity" href="mailto:dallarosaluizfelipe@gmail.com">dallarosaluizfelipe@gmail.com</a>
                  <br />
