      ...
      <main className="max-w-7xl mx-auto px-6 pb-40">
        <div className="grid md:grid-cols-12 gap-20 md:gap-32">
          <div className="md:col-span-4 space-y-20 font-sans">
            <section>
              <h5 className="text-[10px] font-bold mb-8 uppercase tracking-[0.4em] opacity-40">Headquarters</h5>
              <p className="text-xl font-light leading-relaxed uppercase tracking-widest text-neutral-800">
            ...
            <section>
              ...
              <p className="text-xl font-light uppercase tracking-widest text-neutral-800">
            ...
            <section>
              ...
              <ul className="text-xl font-light space-y-4 uppercase tracking-widest text-neutral-800">
