...
const Home: React.FC<{onNavigate: (page: string) => void;}> = ({ onNavigate }) => {
  return (
    <div className="animate-in fade-in duration-700">
      {/* Hero Section */}
      <section className="relative h-screen flex flex-col justify-center items-center overflow-hidden bg-black text-white rounded-b-[4rem] md:rounded-b-[6rem] pt-32 md:pt-40">
        ...
        <div className="relative z-10 max-w-6xl w-full text-center px-6">
          <h1 className="text-white text-7xl leading-[0.9] mb-12 tracking-tight font-display md:text-8xl text-center">Poder criativo que 
